  ...
  <div class="">
    <div class="page-title">
      ...
      <div class="title_right">
        <form method="GET" action="{{route('cons.liste.search')}}" > 
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
                ...
                <form method="GET" action="{{route('cons.liste.searchDate')}}" > 
                ...
                <a  href="{{ route('cons.liste')}}" class="btn btn-round btn-default" >Toute les consommations</a>
                <p>Liste des consommations existants dans l'hotel.</p>
                ...
                ?>
                  <tr style="cursor: pointer">
                    ...
                    <td>
                      ...
                      <a href="{{ route('cons.delete',['id'=>$c->id]) }}" onclick="return confirm('Voulez vous supprimer ?')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>  </a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
            ...
            <div class="col-md-4 col-sm-3 col-xs-12">
              ...
              <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <h3 class="green"><i class="fa fa-paint-brush"></i>Modifier consommation </h3>
                    <br>
                    <p>Veuillez modifier les formulaires ci-dessous pour modifier la consommation.</strong></p>
                      <!-- start form for validation -->
                    <form method="POST" action="{{ route('cons.edit.submit') }}" onsubmit="return checkEmptyInput()" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      ...
                      <input type="text" class="form-control{{ $errors->has('designation') ? ' parsley-error' : '' }}" name="designation" id="designation"  />
                        ...
                        @endif
                      <label for="qte">Quatite :</label>
                      <input  type="number" class="form-control{{ $errors->has('qte') ?  ' parsley-error' : '' }}" name="qte"  id="qte" />
                        @if ($errors->has('qte'))
                            <span class="help-block">
                      ...
                      <input type="text" class="form-control{{ $errors->has('prix_unique') ? ' parsley-error' : '' }}" name="prix_unique" id="prix_unique"     />
                  ...
                  function selectedRowToInput()
                  {
                      ...
                      for(var i = 1; i < table.rows.length; i++)
                      {
                          table.rows[i].onclick = function()
                          {
                            ...
                            document.getElementById("qte").value = this.cells[2].innerHTML;
                            document.getElementById("prix_unique").value = this.cells[3].innerHTML;
