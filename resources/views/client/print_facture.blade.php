    ...
    @foreach($resListe as $liste)  
      ...
      <section id="sums">
        ...
        @foreach($resListe as $rese)
          ...
          <tr data-iterate="tax">
          <td><a href="{{ route('facture.print',['id_cli'=>$liste->cli,'id_res'=>$liste->id ]) }}" target="_blank" style="text-align: center;text-decoration: none;background-color: #b7b3ac;padding: 14px;width: 30%; color: white;">IMPRIMER</a>&nbsp<a href="{{ route('client.facture') }}" style="text-align: center;text-decoration: none;background-color: #b7b3ac;padding: 14px;width: 30%; color: white;">RETOUR</a></td>
          </tr>
        </table>
