          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="{{ route('admin.login') }}">
                ...
                <span class="nav-link-inner--text">Connexion</span>a
              </a>
            </li>
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">Creer un compte pour la gestion d'hotel.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-3"><small>Page de registre pour les administrateurs</small></div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form class="form-horizontal" method="POST" action="{{ route('admin.register.submit') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                   <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="form-group{{ $errors->has('prenom_resp') ? ' has-error' : '' }}">
                        <div class="input-group input-group-alternative">
                            <div class="input-group-prepend">
                            <span class="input-group-text"><i class="ni ni-hat-3"></i></span>
                            </div>
                            <input id="prenom_resp" placeholder="Prenom" type="text" class="form-control " name="prenom_resp" value="{{ old('prenom_resp') }}">

                           
                        </div>
                        @if ($errors->has('prenom_resp'))
                            <span class="help-block">
                                <strong style="color:red">{{ $errors->first('prenom_resp') }}</strong>
                            </span>
                        @endif
                    </div>
                    <div class="form-group{{ $errors->has('adrs_resp') ? ' has-error' : '' }}">
                        <div class="input-group input-group-alternative">
                            <div class="input-group-prepend">
                            <span class="input-group-text"><i class="ni ni-briefcase-24"></i></span>
                            </div>
                            <input id="adrs_resp" placeholder="Adresse" type="text" class="form-control " name="adrs_resp" value="{{ old('adrs_resp') }}" required>

                           
                        </div>
                        @if ($errors->has('adrs_resp'))
                            <span class="help-block">
                                <strong style="color:red">{{ $errors->first('adrs_resp') }}</strong>
                            </span>
                        @endif
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('tel_resp') ? ' has-error' : '' }}">
                        <div class="input-group input-group-alternative">
                            <div class="input-group-prepend">
                            <span class="input-group-text"><i class="ni ni-mobile-button"></i></span>
                            </div>
                            <input id="tel_resp" placeholder="Telephone" type="text" class="form-control " name="tel_resp" value="{{ old('tel_resp') }}" required>

                           
                        </div>
                        @if ($errors->has('tel_resp'))
                            <span class="help-block">
                                <strong style="color:red">{{ $errors->first('tel_resp') }}</strong>
                            </span>
                        @endif
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('job_title') ? ' has-error' : '' }}">
                        <div class="input-group input-group-alternative">
                            ...
                            <input id="job_title" placeholder="Fonction" type="text" class="form-control " name="job_title" value="{{ old('job_title') }}" required>
            ...
            <div class="row mt-3">
                ...
                <div class="col-6 text-right">
                    <a href="{{ route('admin.login') }}" class="text-light"><small>Connecter</small></a>
                </div>
            </div>
            </div>
      </div>
